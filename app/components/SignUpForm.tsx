...
export function SignUpForm({ code }: SignUpFormProps) {
	return (
		<form className="flex flex-col p-4 bg-white rounded-2xl" action="/email" method="POST">
			...
			<div className="px-2">
				<div className="flex flex-col" style={{ width: '300px' }}>
					...
					<input required className="border p-2 mb-4 rounded-lg" type="email" id="email" name="email" placeholder="Enter your email" />
